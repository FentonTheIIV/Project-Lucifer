...
Delete all existing planet mods, install the dependecies, then download project lucifer. Unzip it and then drop the "ProjectLucifer" folder inside it into your gamedata folder. Then, if you don't have Parallax Continued installed, delete the parallax configs folder from insid the Project Lucifer folder. Same goes if you don't have EVE V5 volumetrics or scatterer. That's it! You're all set! Have fun.
...
- Finishing the mod
- Polishing the existing planets
- Story mode
